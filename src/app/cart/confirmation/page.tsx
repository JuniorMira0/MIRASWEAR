          ...
          <div className="mx-auto max-w-7xl">
            <div className="flex items-center justify-center py-24">
              <div className="text-center">
                <Image src="/empty-cart.png" alt="Carrinho vazio" className="mx-auto h-48 w-48" width={192} height={192} />
                ...
                <div className="mt-6">
                  <a href="/" className="inline-block rounded-md bg-black text-white px-4 py-2">Continuar comprando</a>
                </div>
              </div>
            </div>
          </div>
